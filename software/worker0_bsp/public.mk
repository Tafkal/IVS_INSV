...
# CPU Name 
# setting CPU_NAME is workers_cpu_0
CPU_NAME = workers_cpu_0
...
# setting hal.stderr is workers_jtag_uart_0
ELF_PATCH_FLAG  += --stderr_dev workers_jtag_uart_0

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is workers_jtag_uart_0
ELF_PATCH_FLAG  += --stdin_dev workers_jtag_uart_0
...
# setting hal.stdout is workers_jtag_uart_0
ELF_PATCH_FLAG  += --stdout_dev workers_jtag_uart_0
